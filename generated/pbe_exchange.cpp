...
XcKernelValue PbeExchange(
    ...
    result.vsigmaAa =
        -rhoA * 3. * C99 * 1.4119203048213739 * C97 /
        (1.608 * C101 * 2 * C97 * C102 *
         std::pow(0.2195149727645171 * std::pow(C97 / C102, 2) / 0.804 + 1., 2) * 4. * Pi);
    ...
    result.vsigmaBb =
        -rhoB * 3. * C112 * 1.4119203048213739 * C110 /
        (1.608 * C114 * 2 * C110 * C115 *
         std::pow(0.2195149727645171 * std::pow(C110 / C115, 2) / 0.804 + 1., 2) * 4. * Pi);
